...
params:  
  input_datatable: !r mtcars ### note that the table not a reference or path
---
...
peptide_tidyed <- tidy_peptides(params$input_datatable)


# This lines is only for debugging
...
```{r echo=FALSE,fig.width= 8,fig.height=6}
  ...
  df_intensity_log10 <-log10(df_intensity[index_keep, ]+1)
