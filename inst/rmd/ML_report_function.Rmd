...
if(is.null(meta_table)){
  ...
  pheatmap::pheatmap(data_fun_COG[,-1], annotation_col = meta, scale = "row")
}
...
if(is.null(meta_table)){
  ...
  meta <- meta_table[,3, drop = FALSE]# for the report, only the first meta is used
  rownames(meta) <- colnames(data_fun_COG[,-1])
  pheatmap::pheatmap(data_fun_NOG[,-1], annotation_col = meta, scale = "row")
}
...
if(is.null(meta_table)){
  ...
  meta <- meta_table[,3, drop = FALSE]# for the report, only the first meta is used
  rownames(meta) <- colnames(data_fun_COG[,-1])
  pheatmap:: pheatmap(data_fun_KEGG[,-1], annotation_col = meta, scale = "row")
}
